...
//	University university1=new University(1,"Presii",address,null);
	
//	@Test
	void testaddUniversity() {
		Address address=new Address("abc");
		University university=new University(1,"Presi",address,null);
		University university2=new University(2,"GLA",address,null);
